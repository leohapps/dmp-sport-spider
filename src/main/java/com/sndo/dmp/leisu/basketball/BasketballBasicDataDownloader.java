...
public class BasketballBasicDataDownloader extends HttpClientDownloader {

    private final MongoCollection<Document> collection;

    public BasketballBasicDataDownloader() {
        collection = MongoServer.getCollection("leisu-basketball", "html");
    }
